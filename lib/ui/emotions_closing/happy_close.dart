...
class HappyClose extends StatefulWidget {
  const HappyClose({super.key});

  @override
  State<HappyClose> createState() => _HappyCloseState();
}

class _HappyCloseState extends State<HappyClose> {
  int _randomIndex = 0;
