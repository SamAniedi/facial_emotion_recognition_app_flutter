...
class SurpriseClose extends StatefulWidget {
  const SurpriseClose({super.key});

  @override
  State<SurpriseClose> createState() => _SurpriseCloseState();
}

class _SurpriseCloseState extends State<SurpriseClose> {
  int _randomIndex = 0;
          ...
          children: [
            ...
            Container(
              ...
              child: Wrap(
                ...
                children: [
                  Text(
                    "When you are calm, possessing inner peace, emotional detachment and inner strength, external events lose their power over you.",
