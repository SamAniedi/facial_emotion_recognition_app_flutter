...
class DisgustClose extends StatefulWidget {
  const DisgustClose({super.key});

  @override
  State<DisgustClose> createState() => _DisgustCloseState();
}

class _DisgustCloseState extends State<DisgustClose> {
  int _randomIndex = 0;
